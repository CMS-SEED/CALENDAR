...
use Form;
use Cms_Framework_Seed\Calendar\Http\Requests\CalendarRequest;
use Cms_Framework_Seed\Calendar\Interfaces\CalendarRepositoryInterface;
use Cms_Framework_Seed\Calendar\Models\Calendar;
...
class CalendarResourceController extends BaseController
{
    ...
    public function __construct(CalendarRepositoryInterface $calendar)
    {
        ...
        $this->repository
            ...
            ->pushCriteria(\Cms_Framework_Seed\Calendar\Repositories\Criteria\CalendarResourceCriteria::class);
    }
    ...
    public function draft(CalendarRequest $request)
    {
        ...
        $calendars = $this->repository
            ->pushCriteria(new \Cms_Framework_Seed\Calendar\Repositories\Criteria\CalendarAdminCriteria())
            ->pushCriteria(new \Cms_Framework_Seed\Calendar\Repositories\Criteria\CalendarEventCriteria())
